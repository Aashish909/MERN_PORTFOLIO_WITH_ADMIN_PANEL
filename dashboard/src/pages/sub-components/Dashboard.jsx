    ...
    <>
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
        <main className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-2 xl:grid-cols-2">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 lg:col-span-2">
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4 md:col-span-2">
              ...
              <CardHeader className="px-7 flex items-center justify-between flex-row">
                ...
                <div className="flex gap-2">
                  <Link to="/manage/projects">
                    <Button className="w-fit">Manage Projects</Button>
                  </Link>
                </div>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="px-7 gap-3 flex items-center justify-between flex-row">
                <CardTitle>Skills</CardTitle>
                 <div className="flex gap-2">
                   <Link to="/manage/skills">
                     <Button className="w-fit">Manage Skills</Button>
                   </Link>
                 </div>
              </CardHeader>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="md:table-cell text-center">Actions</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {softwareApplications && softwareApplications.length > 0 ? (
                      ...
                      <TableRow>
                        <TableCell colSpan={2} className="text-center text-3xl overflow-y-hidden">
